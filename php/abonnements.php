<?php
	...
	//Requete cherchant tout les abonnements de l'utilisateur conecté
	$req="SELECT *
	...
	pb_html_debut("Cuiteur | Abonnements", CHARSET, "../styles/cuiteur.css");
	
		echo '<body>',
			'<div id="bcPage"><header>';
		
			pb_aff_cuiteur_Header_Liens();
			pb_aff_cuiteur_Header_Titre("Vos Abonnements");
			...
			echo '<section>',
			'<ul id="bcMessages"><form method=POST action="abonnements.php?utID='.$_SESSION['usID'].'">';
