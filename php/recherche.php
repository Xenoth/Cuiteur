<?php
	...
	//Si le bouton rechercher a été entrer, on lance une requete dans la tab users pour récupérer les pseudos correspondant au motif voulu
	...
	echo '<div id="headerBas">',
		...
		echo '<section>',
			...
			{
				//On recupère toutes les données necessaires pour l'affichage de son profils (blablas, mentions, abonnes, abonnements, et si l'utilisateur connecter est abonné ou non à lui)
