<?php
	...
	pb_html_debut("Cuiteur | Suggestion", CHARSET, "../styles/cuiteur.css");
	echo '<body>',
		'<div id="bcPage"><header>';
			
		pb_aff_cuiteur_Header_Liens();
		pb_aff_cuiteur_Header_Titre("Suggestions");
		echo '</header>';
		...
		//Requetes récupérant les abonnements de nos abonnés (suggestions)
		$req="SELECT *
			FROM users
		...
		echo '<section>',
			'<ul id="bcMessages"><form method=POST action="suggestions.php">';
			...
			echo '<input type="submit" name="btnValider" value="Valider" class="button"></form></ul></section>';
